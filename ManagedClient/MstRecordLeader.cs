...
namespace ManagedClient
{
    ...
    public sealed class MstRecordLeader
    {
        #region Constants
        ...
        public static MstRecordLeader Read(Stream stream)
        {
            MstRecordLeader result = new MstRecordLeader
            {
            ...
            Debug.Assert(result.Base == 
                (LeaderSize + result.Nvf * MstDictionaryEntry.EntrySize));
