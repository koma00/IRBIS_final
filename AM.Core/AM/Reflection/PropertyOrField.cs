...
namespace AM.Reflection
{
    ...
    /// 
    /// </summary>
    public sealed class PropertyOrField : IComparable < PropertyOrField >
    {
        #region Properties
        ...
        public bool IsIndexed
        {
            ...
            get
            {
                return ( IsProperty && ( PropertyInfo.GetIndexParameters ()
                                                     .Length != 0 ) );
            }
        }
        ...
        public PropertyOrField ( MemberInfo memberInfo )
        {
                 ...
                 && !( memberInfo is FieldInfo ) )
            {
                throw new ArgumentException
                    ( "Member neither property nor field" );
            }
        ...
        /// <param name="inherit">if set to <c>true</c> [inherit].</param>
        /// <returns></returns>
        public bool HaveAttribute < T > ( bool inherit ) where T : Attribute
        {
